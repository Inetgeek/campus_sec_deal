...
public class OrderManageController {
    ...
    public JsonResultUtil<?> genOrder(@RequestBody Map<String, String> order, @NotNull HttpServletRequest request) {
        /**
    ...
    public JsonResultUtil<?> payOrder(@RequestBody Map<String, String> order, @NotNull HttpServletRequest request) {
        /**
    ...
    public JsonResultUtil<?> getOrder(@NotNull HttpServletRequest request) {
        ...
        if (uid == null) {
             ...
             */
            //封装成json
            Map<String, List<PublishCoOder>> order_data = orderService.getAllOrder(uid, pageNum, pageSize);
            // 过滤掉超时的订单
    ...
    public JsonResultUtil<?> cancelOrder(@RequestBody Map<String, String> order, @NotNull HttpServletRequest request) {
        /**
         * 取消订单是用户主动取消的接口
    ...
    public JsonResultUtil<?> overOrder(@RequestBody Map<String, String> order, @NotNull HttpServletRequest request) {
        String token = request.getHeader("token");
        //从token中取出用户ID
        String uid = JWTUtil.verifyToken(token, "user_id");
        if (uid == null) {
